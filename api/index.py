...
class GameInfo:
    def __init__(self):
        self.TitleId: str = "840A4" # Playfab Title Id
        self.SecretKey: str = "PRRSU1YTOFNXSHG5FE5HDS1PEOYNDKS4WNX6ZBKWCKSXUXU3ZO" # Playfab Secret Key
        self.ApiKey: str = "OC|1164473386756839|18db4a9a83f7172811839875b798e728" # App Api Key
...
def titledata():
    response_data = {
        ...
        "MOTD": "<color=red>WELCOME TO TREE TAGGERS!</color>\n<color=yellow>OWNER IS F1MER</color>\n<color=lime>DEVELOPER IS LAXLEP</color>\n<color=blue>discord.gg/quivertag</color>",
